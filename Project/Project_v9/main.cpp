...
int main(int argc, char** argv) {
    ...
    //Finishing Stats
    cout<<"Here are your Final Game Stats:"<<endl<<endl;
    cout<<"Wins:    "<<setw(4)<<nwins<<endl;
    cout<<"Losses:  "<<setw(4)<<nlosses<<endl;
    ...
    cout<<"You won  "<<pwins*100<<"% of the hands you played"<<endl;
    cout<<"You lost "<<plosses*100<<"% of the hands you played"<<endl;
